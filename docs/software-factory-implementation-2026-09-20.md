...
| Test tiers          | Fast Node tests separated from real Swamp integration; umbrella preserves required coverage                                                              | 124 fast Node tests and 64 extension tests pass; Linux worker canary is skipped on macOS. Visual-suite decomposition and measured cold/warm critical paths remain.                                                         |
...
Focused verification: 64 Deno extension tests pass; one pre-existing Linux-only
