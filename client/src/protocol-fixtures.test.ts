...
import { PROTOCOL_VERSION, type AgentStateEvent } from "../../protocol/generated/agent-state-event";

describe("shared protocol fixtures", () => {
  it.each([snapshot, unsupported, upsert, remove, heartbeat])("round trips versioned fixture", (fixture) => {
